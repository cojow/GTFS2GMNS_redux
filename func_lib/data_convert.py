...
#Currently treating all transit types as the same.
def allowed_use_function(route_type: str) -> str:
    ...
    allowed_use_dict = {0: "t", #"w_bus_only;w_bus_metro;d_bus_only;d_bus_metro",
                        1: "t", #"w_metro_only;w_bus_metro;d_metro_only;d_bus_metro",
                        2: "t", #"w_rail_only;d_rail_only",
                        3: "t" #"w_bus_only;w_bus_metro;d_bus_only;d_bus_metro"
                        }
...
'Modify so that it reads weither mile or SI units are used.'
